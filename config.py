...
WHOLESALER_GOOGLE_SHEET_XLSX_URL = ""
...
WHOLESALER_STORE_ROLE_IDS = []
WHOLESALER_DATA_DIR = os.getenv("WHOLESALER_DATA_DIR", str(BASE_DIR / "data" / "wholesaler"))
WHOLESALER_STATE_FILE = os.getenv("WHOLESALER_STATE_FILE")
WHOLESALER_STORE_STATE_FILE = os.getenv("WHOLESALER_STORE_STATE_FILE")
WHOLESALER_WHOLESALE_FILE = os.getenv("WHOLESALER_WHOLESALE_FILE")
WHOLESALER_STORE_INVENTORY_DIR = os.getenv("WHOLESALER_STORE_INVENTORY_DIR")
WHOLESALER_TX_FILE = os.getenv("WHOLESALER_TX_FILE")
